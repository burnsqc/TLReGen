...
public class TLReGenForgeBiomeModifier extends MasterResourceGenerator implements DataProvider {
	private final CompletableFuture<HolderLookup.Provider> completables = lookupProvider.thenApply(r -> constructRegistries(r, new TLReGenRegistrySetBuilder().add(ForgeRegistries.Keys.BIOME_MODIFIERS, TLReGenForgeBiomeModifier::bootstrap)));
	...
	public static void bootstrap(final BootstapContext<BiomeModifier> bootstrapContext) {
		TLReGenForgeBiomeModifier.setBootstrapContext(bootstrapContext);
	...
	protected static void setBootstrapContext(BootstapContext<BiomeModifier> bootstrapContextIn) {
