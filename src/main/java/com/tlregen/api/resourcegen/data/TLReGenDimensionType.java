...
public class TLReGenDimensionType extends MasterResourceGenerator implements DataProvider {
	private final CompletableFuture<HolderLookup.Provider> completables = lookupProvider.thenApply(r -> constructRegistries(r, new TLReGenRegistrySetBuilder().add(Registries.DIMENSION_TYPE, TLReGenDimensionType::bootstrap)));
	...
	public static BootstapContext<DimensionType> bootstrapContext;
	public static DynamicRegister<DimensionType> dynamicRegister;

	public TLReGenDimensionType(DynamicRegister<DimensionType> dynReg) {
		dynamicRegister = dynReg;
	}

	public static void bootstrap(final BootstapContext<DimensionType> bootstrapContext) {
		TLReGenDimensionType.setBootstrapContext(bootstrapContext);
	...
	protected static void setBootstrapContext(BootstapContext<DimensionType> bootstrapContextIn) {
