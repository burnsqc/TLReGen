...
public class TLReGenWorldgenStructureSet extends MasterResourceGenerator implements DataProvider {
	private final CompletableFuture<HolderLookup.Provider> completables = lookupProvider.thenApply(r -> constructRegistries(r, new TLReGenRegistrySetBuilder().add(Registries.STRUCTURE_SET, TLReGenWorldgenStructureSet::bootstrap)));
	...
	public static void bootstrap(final BootstapContext<StructureSet> bootstrapContext) {
		TLReGenWorldgenStructureSet.setBootstrapContext(bootstrapContext);
	...
	protected static void setBootstrapContext(BootstapContext<StructureSet> bootstrapContextIn) {
