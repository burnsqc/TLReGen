...
public class TLReGenWorldgenNoise extends MasterResourceGenerator implements DataProvider {
	private final CompletableFuture<HolderLookup.Provider> completables = lookupProvider.thenApply(r -> constructRegistries(r, new TLReGenRegistrySetBuilder().add(Registries.NOISE, TLReGenWorldgenNoise::bootstrap)));
	...
	public static BootstapContext<NoiseParameters> bootstrapContext;
	public static DynamicRegister<NoiseParameters> dynamicRegister;

	public TLReGenWorldgenNoise(DynamicRegister<NoiseParameters> dynReg) {
		dynamicRegister = dynReg;
	}

	public static void bootstrap(final BootstapContext<NoiseParameters> bootstrapContext) {
		TLReGenWorldgenNoise.setBootstrapContext(bootstrapContext);
	...
	public final String getName() {
		return "data." + modID + ".worldgen.noise";
	}
	...
	protected static void setBootstrapContext(BootstapContext<NoiseParameters> bootstrapContextIn) {
