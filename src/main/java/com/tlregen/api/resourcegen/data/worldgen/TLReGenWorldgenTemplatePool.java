...
public class TLReGenWorldgenTemplatePool extends MasterResourceGenerator implements DataProvider {
	private final CompletableFuture<HolderLookup.Provider> completables = lookupProvider.thenApply(r -> constructRegistries(r, new TLReGenRegistrySetBuilder().add(Registries.TEMPLATE_POOL, TLReGenWorldgenTemplatePool::bootstrap)));
	...
	public static BootstapContext<StructureTemplatePool> bootstrapContext;
	public static DynamicRegister<StructureTemplatePool> dynamicRegister;

	public TLReGenWorldgenTemplatePool(DynamicRegister<StructureTemplatePool> dynReg) {
		dynamicRegister = dynReg;
	}

	public static void bootstrap(final BootstapContext<StructureTemplatePool> bootstrapContext) {
		TLReGenWorldgenTemplatePool.setBootstrapContext(bootstrapContext);
	...
	public final String getName() {
		return "data." + modID + ".worldgen.template_pool";
	}
	...
	protected static void setBootstrapContext(BootstapContext<StructureTemplatePool> bootstrapContextIn) {
