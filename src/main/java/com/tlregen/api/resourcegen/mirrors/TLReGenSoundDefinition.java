package com.tlregen.api.resourcegen.mirrors;
...
public final class TLReGenSoundDefinition {
	...
	public TLReGenSoundDefinition replace(final boolean replace) {
		this.replace = replace;
		return this;
	}

	public TLReGenSoundDefinition subtitle(@Nullable final String subtitle) {
		this.subtitle = subtitle;
		return this;
	}

	public TLReGenSoundDefinition with(final Sound sound) {
		this.sounds.add(sound);
		return this;
	}

	public TLReGenSoundDefinition with(final Sound... sounds) {
